...
public class ferramentas_AdminActivity extends AppCompatActivity {
    ...
    private void ShowData(){
        db.collection("Ferramentas").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ferramentas_AdminActivity.this, "Alguma coisa correu mal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}